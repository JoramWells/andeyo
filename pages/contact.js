...
function Contact() {
  return (
    <>
      ...
      <Navigation />
      <main>
      <div className="min-h-screen flex justify-center bg-gray-50 py-10 px-4 sm:px-6 lg:px-8 shadow-2xl">
      <div className="max-w-sm w-full space-y-8 border-gray-500">
